	...
	<body>
		<center>
			<div id="overall">
				...
				<div>
					<div id="download">
						<a href="dyn2a.csv" style="text-decoration: none;">[Download]</a>
					</div>
					<div id="n2a">
				...
				<div>
					<div id="download">
						<a href="dya2n.csv" style="text-decoration: none;">[Download]</a>
					</div>
					<div id="a2n">
				...
				<div>
					<div id="download">
						<a href="dym2a.csv" style="text-decoration: none;">[Download]</a>
					</div>
					<div id="m2a">
				...
				<div>
					<div id="download">
						<a href="dya2m.csv" style="text-decoration: none;">[Download]</a>
					</div>
					<div id="a2m">
		...
		<script type="text/javascript">
			...
			$time = date("H");
			$dateDownTwo = date("m-d-Y",strtotime("-14 days", strtotime("now")));
			$td = $dateDownTwo . " " . $time;
